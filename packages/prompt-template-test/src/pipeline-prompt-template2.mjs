 ...
 * @Date: 2026-05-02 10:14:17
 * @LastEditors: 张泽全 hengwujun128@gmail.com
 * @LastEditTime: 2026-05-02 10:14:38
 * @Description:
 * @FilePath: /llm-lab/packages/prompt-template-test/src/pipeline-prompt-template2.mjs
 */
...
现在请生成本次的【季度 OKR 回顾邮件】：`),
  inputVariables: ['tone', 'company_name', 'team_name', 'manager_name', 'week_range', 'team_goal', 'okr_facts'],
})
