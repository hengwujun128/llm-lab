 ...
 * @Date: 2026-05-02 09:57:19
 * @LastEditors: 张泽全 hengwujun128@gmail.com
 * @LastEditTime: 2026-05-02 10:40:46
 * @Description:
 * @FilePath: /llm-lab/packages/prompt-template-test/src/pipeline-prompt-template.mjs
 */
...
// A. 人设模块(角色)
export const personaPrompt = PromptTemplate.fromTemplate(`你是一名资深工程团队负责人，写作风格：{tone}。
...
// C. 任务模块
export const taskPrompt = PromptTemplate.fromTemplate(`以下是本周团队的开发活动（Git / Jira 汇总）：
{dev_activities}
...
// D. 格式模块(输出格式)
export const formatPrompt = PromptTemplate.fromTemplate(`请用 Markdown 输出周报，结构包含：
