 ...
 * @Date: 2026-04-23 21:21:58
 * @LastEditors: 张泽全 hengwujun128@gmail.com
 * @LastEditTime: 2026-04-23 21:24:20
 * @Description: 删除数据（Milvus 通过 delete 实现删除）
 * @FilePath: /milvus-test/src/delete.mjs
 */
...
async function main() {
  try {
    ...
    // NOTE: 删除, 这个不用向量化数据，也就不用嵌入模型。直接通过 id 删除。
    console.log('Deleting diary entry...')
    const deleteId = 'diary_005'

    // NOTE: 通过 id删除单条数据, 通过 filter 条件删除
