 ...
 * @Date: 2026-04-23 21:16:46
 * @LastEditors: 张泽全 hengwujun128@gmail.com
 * @LastEditTime: 2026-04-23 21:21:08
 * @Description: 更新数据（Milvus 通过 upsert 实现更新）
 * @FilePath: /milvus-test/src/update.mjs
 */
...
async function main() {
  try {
    ...
    // NOTE: 将向量化的内容和要更新的内容一起插入到 Milvus 中
    const updateData = { ...updatedContent, vector }

    // NOTE: 更新数据（Milvus 通过 upsert 实现更新）
