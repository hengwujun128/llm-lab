 ...
 * @Date: 2026-05-01 21:14:21
 * @LastEditors: 张泽全 hengwujun128@gmail.com
 * @LastEditTime: 2026-05-01 21:15:26
 * @Description:
 * @FilePath: /llm-lab/packages/output-parser-test/src/test/smart-import.mjs
 */
...
// DashScope(Qwen) 不支持 jsonSchema，functionCalling 要求顶层必须是 object
const friendsListSchema = z.object({
  items: z.array(friendSchema).describe('好友信息数组'),
})

const structuredModel = model.withStructuredOutput(friendsListSchema, {
